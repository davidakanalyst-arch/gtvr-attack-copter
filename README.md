...
- `tools/build_gtvr_repaint_source.py` - generates source PNGs for the safe tactical repaint.
- `tools/run_aerofly_converter.py` - drives the Aerofly converter GUI using the discovered launch contract.
- `tools/install_gtvr_repaint_textures.py` - installs converted tactical repaint textures with backups.
